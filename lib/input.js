...
class Input {
  constructor() {
    ...
    this.updateID = args[this.methods[5]].split(",")[0] || undefined;
    this.update = {
      Text: args[this.methods[5]].split(",")[1],
      Category: args[this.methods[5]].split(",")[2]
    }
  }
  ...
  getMethods(args) {
    ...
    if (args) {
      ...
      return [addMethod, categoryMethod, getNotes, deleteMethod, deleteFilter, updateMethod];
    } else {
      return undefined;
    }
  }
